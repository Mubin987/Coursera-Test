function quiz(){
    ...
    var choices = [['String','Boolean','Float','Function'],['var = myVariable;','variable myVariable;','myVariable;','declare myVariable;'],['4','\"22\"','\"4\"','TypeError'],['<!-- This is a comment -->','/* This is a comment */','// This is a comment','** This is a comment **'],['pop()','remove()','delete()','shift()']]
    for(var i=0;i<5;i++){
...
function results(){
    var answers = ['Float','myVariable;','"22"','// This is a comment','pop()']
    // console.log("r")
   // do{
        submitPressed = false;
        var flag = true
